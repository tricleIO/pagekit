...
use Tricle\Gallery\Content\SlideshowPlugin;
use Tricle\Gallery\Events\RouteListener;
...
return [
    ...
    'nodes' => [
        ...
        'Gallery' => [
            'name'       => '@gallery',
            'label'      => 'Gallery',
            'controller' => 'Tricle\\Gallery\\Controller\\SiteController',
            'protected'  => true,
    ...
    'routes' => [
        ...
        '/gallery' => [
            'name'       => '@gallery',
            'controller' => [
                'Tricle\\Gallery\\Controller\\GalleryController',
            ],
        ],
        ...
        '/api/gallery' => [
            'name'       => '@gallery/api',
            'controller' => [
                'Tricle\\Gallery\\Controller\\GalleryApiController',
                'Tricle\\Gallery\\Controller\\ImageApiController',
            ],
        ],
